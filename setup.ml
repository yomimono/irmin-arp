...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9b44b10fa00bbc5ce34eae04f68df664) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_table",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_table", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_arp",
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "true to build network demo";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Irmin_arp"; "Table"; "Entry"; "Key"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "irmin-arp";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "demo_network";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "demo_network.ml"});
               Executable
                 ({
                     cs_name = "test_ops";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_ops.ml"});
               Executable
                 ({
                     cs_name = "test_table";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_table.ml"});
               Executable
                 ({
                     cs_name = "test_arp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_arp.ml"});
               Test
                 ({
                     cs_name = "test_ops";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "=#\140\127U\014\158\176V\162\001\n\234>\149\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
