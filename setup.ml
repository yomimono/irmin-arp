...
(* OASIS_START *)
(* DO NOT EDIT (digest: 295f1f60a30cdb7a76010de590f8ee9d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "demo_network.ml"});
               Executable
                 ({
                     cs_name = "test_arp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_arp.ml"});
               Test
                 ({
                     cs_name = "test_arp";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "0\246m'^\249\012\194\220)\133n\127i\245/";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
